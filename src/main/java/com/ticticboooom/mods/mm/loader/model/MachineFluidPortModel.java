...
public class MachineFluidPortModel {
    public static final Codec<MachineFluidPortModel> CODEC = RecordCodecBuilder.create(x -> x.group(
    ...
    ).apply(x, (s, integer, integer2, integer3, s2, s3, s4, s5, s6) ->
            new MachineFluidPortModel(s, integer, integer2, integer3, s2.orElse(null), s3.orElse(null), s4.orElse(null), s5.orElse(null), s6.orElse(null))));
    ...
    public MachineFluidPortModel(String idPrefix, int capacity, int inputMax, int outputMax, String baseTexture, String inputOverlayTexture, String outputOverlayTexture, String inputDetailTexture, String outputDetailTexture) {
